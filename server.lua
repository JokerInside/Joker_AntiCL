local webhook = "https://discord.com/api/webhooks/1248974588705243157/fZMz4q-LFTlavP-XYHezRhatX1UyKrKcIl9W3m41rwa1M9P0ht-qESV8XiLFKrfUUsxz"

RegisterCommand("combat", function(source, args, rawcmd)
    TriggerClientEvent("Joker_AntiCL:show", source)
end)
...
AddEventHandler("playerDropped", function(reason)
    ...
    TriggerClientEvent("Joker_AntiCL", -1, id, crds, identifier, reason)
